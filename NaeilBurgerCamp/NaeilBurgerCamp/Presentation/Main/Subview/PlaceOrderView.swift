...
final class PlaceOrderView: UIView {
    ...
    private lazy var franchiseLabel: UILabel = {
        let label = UILabel()
        label.text = "내버캠 iOS 마스터 3호점".localized
    ...
    private lazy var orderSuccessMessageLabel: UILabel = {
        ...
        label.text = "주문이 완료되었습니다!".localized
    ...
    func updateOrderButtonTitle(with cart: Cart) {
        ...
        ? "항목을 추가해주세요!".localized
        : "order_button_title".localized(with: cart.totalQuantity, cart.totalPrice)
